...
const String kNameText = 'Enter your name';
const String kPhoneText = 'Enter your Phone';
const String kPasswordText = 'Enter your Password';
const String kEmailText = 'Enter your Email ';
